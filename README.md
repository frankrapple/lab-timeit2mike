...
| -------------- | ------------------------- | --------------------- | 
| `n=2**0`       | .342 usec                 | 1.17  usec            |
| `n=2**1`       | .331 usec                 | 1.85  usec            |
| `n=2**2`       | .707 usec                 | 2.46  usec            |
| `n=2**3`       | .766 usec                 | 1.73  usec            |
| `n=2**4`       | .964 usec                 | 1.94  usec            |
| `n=2**5`       | 1.46 usec                 | 2.32  usec            |
| `n=2**6`       | 3.15 usec                 | 2.99  usec            |
| `n=2**7`       | 7.16 usec                 | 2.91  usec            |
| `n=2**8`       | 9.08 usec                 | 4.94  usec            |
| `n=2**9`       | 18 usec                   | 5.7   usec            |
| `n=2**10`      | 31.6 usec                 | 4.99  usec            |
| `n=2**11`      | 100 usec                  | 5.25  usec            |
| `n=2**12`      | 186 usec                  | 4.74  usec            |
| `n=2**13`      | 235 usec                  | 6.89  usec            |
| `n=2**14`      | 547 usec                  | 6.31  usec            |
| `n=2**15`      | 1.05 msec                 | 8.73  usec            |
| `n=2**16`      | 2.5 msec                  | 6.75  usec            |
| `n=2**17`      | 5.03 msec                 | 9.38  usec            |
| `n=2**18`      | 8.91 msec                 | 8.66  usec            |
| `n=2**19`      | 13.5 msec                 | 7.25  usec            |
| `n=2**20`      | 53 msec                   | 8.38  usec            |
| `n=2**21`      | 65.7 msec                 | 8.41  usec            |
| `n=2**22`      | 156 msec                  | 11.1  usec            |
